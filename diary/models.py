...
class DiaryIntro(models.Model):
    ...
    wax_seal_color = models.CharField(max_length=20, default="#8b0000", help_text="HEX color for the wax seal.")
...
class DiaryPage(models.Model):
    ...
    chapter_title = models.CharField(
        ...
        help_text="The title displayed under 'The Queen in Motion' (e.g., Chapter I: The Spark)."
    )
